...
pose_1_path = "pictures/pose_1.png"
...
Label_set_times = tk.Label(set_times_frame, text="เซต", font=("Arial", 30), fg="black", bg="#c5e0b5")
Label_set_times.pack(padx=50, pady=(30, 5))

Label_set_times_number = tk.Label(set_times_frame, text="1", font=("Arial", 50), fg="black", bg="#c5e0b5")
